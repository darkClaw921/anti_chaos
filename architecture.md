...
- `EditSphereRating.jsx` - редактирование оценок сфер жизни (доступно из настроек, платные сферы закрыты замочком и недоступны для редактирования, как при онбординге)
